...
import com.example.cryptocurrencyapp.presentation.coin_list.componants.CoinTag
import com.example.cryptocurrencyapp.presentation.coin_list.componants.TeamListItem

@OptIn(ExperimentalLayoutApi::class)
@RequiresExtension(extension = Build.VERSION_CODES.S, version = 7)
@Composable
fun CoinDetailScrean(
    navController: NavController,
    coinId:String,
    viewModule: CoinDetailViewModel= hiltViewModel()
){
